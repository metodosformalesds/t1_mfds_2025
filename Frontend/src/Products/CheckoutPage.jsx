...
// --- Componente PaypalIcon ---
const PaypalIcon = (props) => (
  // NOTA: Ajusté el viewBox para que el logo ocupe el espacio correcto.
  <svg 
...
// --- Componente VisaIcon (Corregido: era Mastercard) ---
// NOTA: El SVG que me pasaste para 'VisaIcon' en realidad es el logo de Mastercard. 
// Lo mantendré con el nombre VisaIcon para seguir tu código, pero ten en cuenta el logo.
